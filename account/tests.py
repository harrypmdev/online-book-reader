...
class TestRegisterForm(TestCase):
    ...
    def test_duplicate_email_is_not_valid(self):
        ...
        self.assertTrue(
            not register_form_to_test.is_valid(),
            msg="Register form is valid."
        )
...
class TestProfileView(TestCase):
    ...
    def test_render_valid_profile_page(self):
        ...
        self.assertEqual(response.status_code, 200,
                        msg="Profile page not returned.")
        self.assertIn(b"existingUser", response.content,
...
class TestLoginView(TestCase):
    ...
    def test_invalid_login_page(self):
        ...
        self.assertRedirects(response, '/profile/', 
                            msg_prefix="Did not redirect to profile.")
